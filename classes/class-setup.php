...
class EDD_DP_Setup {
	...
	public function is_wp_and_edd_activated() {
		...
		} else if ( ! class_exists( 'Easy_Digital_Downloads' ) || ( version_compare( EDD_VERSION, '2.6.8' ) < 0 ) ) {
...
?>
		<div class="updated">
			<p><?php printf( __( '<strong>Notice:</strong> Easy Digital Downloads Discounts Pro requires Easy Digital Downloads 2.6.8 or higher in order to function properly.', 'edd_dp' ) ); ?></p>
		</div>
<?php
	}
...
?>
	<div class="updated">
		<p><?php printf( __( '<strong>Notice:</strong> Easy Digital Downloads Discounts Pro requires WordPress 4.1 or higher in order to function properly.', 'edd_dp' ) ); ?></p>
	</div>
<?php
	}
